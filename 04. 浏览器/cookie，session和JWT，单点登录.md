...
>
> Path属性指定浏览器发出 HTTP 请求时，哪些路径要附带这个 Cookie。只要浏览器发现，Path属性是 HTTP 请求路径的开头一部分，就会在头信息里面带上这个 Cookie。比如，PATH属性是/，
>
> 那么请求/docs路径也会包含该 Cookie。当然，前提是域名必须一致。
>
...
![img](图片/37adb2019d064967923a659848870771tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/4c32c502d26149808bed72c85fea5a97tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/a1c57a08eb204f528256f3980c721148tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/f05aee1b10d24bc7a6a9a42d99529562tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/fb5955e681724ee084e6f46aa6e45666tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/65b5e67305f84e9391de2d5b436600e7tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/b764b256211b4ea182388fd92674fe70tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/65e37941080a4aceb234b74845647f6ctplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/bf2e8ba61fc94b52be164c207b9d8358tplv-k3u1fbpfcp-watermark.awebp)
...
![img](图片/a2513e31953c457fa4245f6a0f525b5atplv-k3u1fbpfcp-watermark.awebp)

对浏览器来说，SSO 域下返回的数据要怎么存，才能在访问 A 的时候带上？浏览器对跨域有严格限制，cookie、localStorage 等方式都是有域限制的。

这就需要也只能由 A 提供 A 域下存储凭证的能力。一般我们是这么做的：

![img](图片/e5a94e9c990d4d69a4a0845c4f8dc6a1tplv-k3u1fbpfcp-watermark.awebp)
